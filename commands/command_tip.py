...
class TipCommand(Command):
    ...
    def process_command(self, comment):
        ...
        if re_result:
            ...
            self.leave_comment_reply(comment, f"u/{comment.author.name} has tipped u/{parent.author.name} {amount} {default_token_meta["name"]}")
            return
        ...
        if re_result:
            ...
            self.leave_comment_reply(comment, f"u/{comment.author.name} has tipped u/{parent.author.name} {amount} {token_meta["name"]}")
            return
